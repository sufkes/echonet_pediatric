...
def objective(hyperparameters):
    ...
    args = {
        ...
        "output": f"/hpf/largeprojects/ccmbio/sufkes/echonet_pediatric/runs/hyperopt-lvef-20220403/hyperopt-lvef-batch_size_{hyperparameters['batch_size']}-lr_{hyperparameters['lr']}-weight_decay_{hyperparameters['weight_decay']}",
        ...
        "note":"first trial hyperopt on LVEF model"
    }
...
hyperparameter_space = {
    ## Batch size
    # Formerly 20
    'batch_size':hyperopt.hp.choice('batch_size', [1,2,4,8,16,20,24]),
...
trials_out_path = '/hpf/largeprojects/ccmbio/sufkes/echonet_pediatric/runs/hyperopt-lvef-20220403-batch_size-lr-weight_decay.pkl'
